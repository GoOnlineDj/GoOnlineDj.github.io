...
const screen = document.querySelector(".calculator-index-body .screen");
...
function valueInit() {
    document.querySelector(".calculator-index-body .calc-buttons").addEventListener("click", function (event) {
